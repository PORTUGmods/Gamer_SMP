...
package com.portug.gamersmp.entity;
...
import com.portug.gamersmp.procedures.DarkgamerptEntityDiesProcedure;
import com.portug.gamersmp.entity.renderer.DarkgamerptRenderer;
import com.portug.gamersmp.GamersmpModElements;

@GamersmpModElements.ModElement.Tag
public class DarkgamerptEntity extends GamersmpModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.95f)).build("darkgamerpt").setRegistryName("darkgamerpt");

	public DarkgamerptEntity(GamersmpModElements instance) {
		super(instance, 5);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkgamerptRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("darkgamerpt_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			DarkgamerptEntityDiesProcedure.executeProcedure(Stream
